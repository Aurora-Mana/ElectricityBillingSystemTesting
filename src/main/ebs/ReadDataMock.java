...
public class ReadDataMock extends ReadData {
        ...
        for (String line : lines) {
            ...
            for (String str : parts) {
                if (j < 8) {
                    ...
                    String lastWord = subparts[subparts.length - 1];
    ...
    public void writeIntoCustomerInfo(String name, String meterNo, String address, String state, String city, String email, String phoneNumber){
